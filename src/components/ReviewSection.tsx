...
const reviews = [
  { text: "친구들 생일파티로 이용했는데 공간이 너무 예쁘고 사진도 잘 나와요! 소품도 다양하고 블루 카펫이 진짜 감성적이에요.", author: "김**", date: "2025.03.15", rating: 5 },
  { text: "브라이덜 샤워로 예약했는데 분위기가 정말 최고였어요. 빈티지 소품들이 너무 귀엽고, 인생샷 건졌습니다!", author: "이**", date: "2025.03.08", rating: 5 },
  { text: "깔끔하고 관리가 잘 되어있어요. 음향 시스템도 좋고 조명도 분위기 있게 바꿀 수 있어서 파티하기 딱이에요.", author: "박**", date: "2025.02.28", rating: 5 },
  { text: "스튜디오 촬영으로 이용했는데 배경이 너무 예뻐서 따로 세팅할 필요가 없었어요. 오렌지 의자랑 블루 카펫 조합이 찐이에요.", author: "최**", date: "2025.02.20", rating: 5 },
  { text: "소규모 팬미팅으로 대여했어요. 아늑하면서도 특별한 공간이라 참석자분들 모두 좋아하셨어요. 사장님도 친절하시고 응대가 빨라요!", author: "정**", date: "2025.02.14", rating: 4 },
  { text: "Y2K 컨셉 촬영하기에 완벽한 공간이에요! 소품 하나하나가 다 감성적이고, 코카콜라 냉장고는 진짜 레트로 그 자체.", author: "한**", date: "2025.01.30", rating: 5 },
  { text: "생일 파티로 이용했어요. 블루 카펫 위에서 찍은 사진이 진짜 예술이에요. 친구들이 다 여기 어디냐고 물어봤어요!", author: "윤**", date: "2025.01.22", rating: 5 },
  { text: "촬영 목적으로 방문했는데 조명이 좋아서 별도 조명 없이도 화보 느낌이 나요. 재방문 의사 100%!", author: "서**", date: "2025.01.15", rating: 5 },
  { text: "소규모 파티에 딱이에요. 분위기도 좋고 소품도 많아서 따로 준비할 게 거의 없었어요. 가성비 최고!", author: "강**", date: "2025.01.10", rating: 5 },
  { text: "친구 결혼 축하 파티로 이용했는데 공간이 너무 예쁘고 아늑해서 모두 만족했어요. 또 올게요!", author: "조**", date: "2025.01.05", rating: 5 },
  { text: "빈티지 감성 가득한 공간에서 특별한 시간을 보냈습니다. 사진 퀄리티가 남달라요!", author: "임**", date: "2024.12.28", rating: 5 },
  { text: "깨끗하고 관리가 잘 되어 있어서 기분 좋게 이용했어요. 다음에 또 예약할게요!", author: "오**", date: "2024.12.20", rating: 4 },
];
...
const ReviewRow = ({ data, speed, reverse = false }: { data: typeof reviews; speed: number; reverse?: boolean }) => {
